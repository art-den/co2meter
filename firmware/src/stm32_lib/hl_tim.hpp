...
namespace detailed { template <> struct TimerHelper<15>
{
...
namespace detailed { template <> struct TimerHelper<16>
{
...
template <> struct TimerChanHelper<1>
{
...
template <> struct TimerChanHelper<2>
{
	static constexpr uint32_t ccmr_offset = offsetof(TIM_TypeDef, CCMR1);
...
template <> struct TimerChanHelper<3>
{
...
template <> struct TimerChanHelper<4>
{
	static constexpr uint32_t ccmr_offset = offsetof(TIM_TypeDef, CCMR2);
